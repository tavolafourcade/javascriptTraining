...
dogs.forEach(dog => dog.recommendedFood = Math.trunc(recommendedFood(dog.weight)))
// console.log(dogs) 
...
// console.log(`Sarah's dog is eating too ${sarahDog.curFood > sarahDog.recommendedFood ? 'much' : 'little'}`) // Sarah's dog is eating too much
...
console.log('ownersEatTooMuch', ownersEatTooMuch) // ownersEatTooMuch ['Matilda', 'Sarah', 'John']
console.log('ownersEatTooLittle', ownersEatTooLittle) // ownersEatTooLittle ['Alice', 'Bob', 'Michael']
...
console.log(dogs.some(dog => checkEatingOkay(dog))) // true
